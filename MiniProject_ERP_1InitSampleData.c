...
void Create_File(void)
{
	...
	// 품목테이블 서버에 생성
	_create("ITEM", "num_jaego INT item_NAME VARCHAR(20) item_NUMBER VARCHAR(20) item_TYPE VARCHAR(20) item_GOAL INT item_LOT VARCHAR(20) item_SirealNUMBER VARCHAR(20)");
...
void Init_SampleData(void)
{
	...
	if (_insert("1,'CPU','CP10','meterial',100,'CP20220308','C19999P19'") == -1) {
	...
	if (_insert("2,'HARD','HR10','meterial',100,'HR20220308','H1999R19'") == -1) {
	...
	if (_insert("3,'KEYBORAD','KE10','submeterial',100,'KE20220308','K1999E19'") == -1) {
	...
	if (_insert("4,'MAINBORAD','MB10','meterial',100,'MB20220308','M1999B19'") == -1) {
	...
	if (_insert("5,'MONITOR','MO10','submeterial',100,'MO20220308','M1999O19'") == -1) {
	...
	if (_insert("6,'CASE','CA10','meterial',100,'CA20220308','C1999A19'") == -1) {
	...
	if (_insert("'1', 'CPU', 'CP10', 555, '1999', 'CP10', 'CP10', 'CP10', 1") == -1)
	{
		printf("%s\n", err_msg);
