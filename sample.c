...
int main() {
	...
	char* conditional = "name_item = kn";
	char* select_column = "name_factory, num_factory, name_item, name_responsible, num_responsible, bill, date, num_item ";
...
/// 
				...
				else if (option3 == 2)
				{
					...
					//	printf("검색할 품명을 입력하시오(ex. name_item = 키보드)\n");
					//	conditional = getchar();
					//	getchar();
